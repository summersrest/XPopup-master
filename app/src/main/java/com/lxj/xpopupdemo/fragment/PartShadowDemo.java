...
import com.lxj.xpopup.widget.easyadapter.MultiItemTypeAdapter;
    ...
    public void init(View view) {
        ...
        EasyAdapter<String> adapter = new EasyAdapter<String>(data, android.R.layout.simple_list_item_1) {
            ...
            protected void bind(@NonNull ViewHolder holder, @NonNull String s, int position) {
                holder.getView(android.R.id.text1).setBackgroundColor(Color.parseColor("#fafafa"));
                holder.setText(android.R.id.text1, "长按我试试 - " + position);
                //必须要在事件发生之前就watch
                final XPopup.Builder builder = new XPopup.Builder(getContext())
                        .hasShadowBg(false).watchView(holder.getView(android.R.id.text1));
                holder.getView(android.R.id.text1).setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
